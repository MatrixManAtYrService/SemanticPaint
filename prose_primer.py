...
class Tokens(Sequence):
    ...
    def __init__(self, data_sequence, regex=".*"):
        ...
        self.pos_range = (_tokens[0].pos_range[0], _tokens[-1].pos_range[1])
